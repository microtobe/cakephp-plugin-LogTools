 ...
 */
	...
	private function _getParams() {
		$params = am($this->_controller->request->named, $this->_controller->request->query, $this->_controller->request->data);
		if (!empty($this->_controller->request->form)) {
			$params = am($params, $this->_controller->request->form);
		}
